...
# Введение
-----------------------------
Данная работа нацелена на изучение методов оптимизаций программы на примере хеш-таблицы. В первой части работы проводится сравнение различных хеш-функций на распределение данных в таблице. Во второй части работы будут применены различные методы оптимизации для хеш-таблицы. Для второй части будет выбрана функция с наиболее равномерным распределением.
# Хеш таблица
...
Для понимания влияния размера таблицы на скорость её работы проведём первый тест (базовая версия) без оптимизаций и с размером таблицы, равным 211. Второй тест (увеличенный размер таблицы) проведём при размере таблицы 10601, также без дополнительных оптимизаций.
