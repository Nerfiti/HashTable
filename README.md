...
Для понимания влияния размера таблицы на скорость её работы проведём первый тест (уменьшённый размер таблицы) без оптимизаций и с размером таблицы, равным 211. Второй тест (базовый) проведём при размере таблицы 10601, также без дополнительных оптимизаций.
