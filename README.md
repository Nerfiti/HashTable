...
--------------------------------------------------------
Для тестирования функций были взяты 5 файлов, состоящих из английских слов. Размер хеш таблицы был равен 1277. Тестировались следующие функции:
...
Для каждой функции считалась дисперсия. В таблице представлены средние значения за пять текстов.
...
|:-------:|:-------:|:-------:|:-----:|:-----:|:-----:|:-----:|:---:|
|Дисперсия| 37000   |  2000   | 4000  |   20  |  1.20 |  8    | 0.99 |
